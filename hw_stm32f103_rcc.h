// inline version of libopencm3/lib/stm32/f1/rcc.c
...
INLINE void hw_rcc_css_int_clear(void)
{
...
INLINE int hw_rcc_css_int_flag(void)
{
...
INLINE void hw_rcc_css_enable(void)
{
	RCC_CR |= RCC_CR_CSSON;
}
...
INLINE void hw_rcc_css_disable(void)
{
	RCC_CR &= ~RCC_CR_CSSON;
}
...
INLINE void hw_rcc_set_sysclk_source(uint32_t clk)
{
...
INLINE void hw_rcc_set_pll_multiplication_factor(uint32_t mul)
{
...
INLINE void hw_rcc_set_pll2_multiplication_factor(uint32_t mul)
{
...
INLINE void hw_rcc_set_pll3_multiplication_factor(uint32_t mul)
{
...
INLINE void hw_rcc_set_pll_source(uint32_t pllsrc)
{
...
INLINE void hw_rcc_set_pllxtpre(uint32_t pllxtpre)
{
...
INLINE void hw_rcc_set_adcpre(uint32_t adcpre)
{
...
INLINE void hw_rcc_set_ppre2(uint32_t ppre2)
{
...
INLINE void hw_rcc_set_ppre1(uint32_t ppre1)
{
...
INLINE void hw_rcc_set_hpre(uint32_t hpre)
{
...
INLINE void hw_rcc_set_usbpre(uint32_t usbpre)
{
	if (usbpre)
...
INLINE void hw_rcc_set_prediv1(uint32_t prediv)
{
	RCC_CFGR2 = (RCC_CFGR2 & ~RCC_CFGR2_PREDIV1) |
			(prediv << RCC_CFGR2_PREDIV1_SHIFT);
}

INLINE void hw_rcc_set_prediv2(uint32_t prediv)
{
	RCC_CFGR2 = (RCC_CFGR2 & ~RCC_CFGR2_PREDIV2) |
			(prediv << RCC_CFGR2_PREDIV2_SHIFT);
}

INLINE void hw_rcc_set_prediv1_source(uint32_t rccsrc)
{
	if (rccsrc)
...
INLINE uint32_t hw_rcc_system_clock_source(void)
{
...
INLINE void hw_rcc_clock_setup_in_hse_8mhz_out_72mhz(void)
{
	 ...
	 */
	hw_rcc_set_hpre(RCC_CFGR_HPRE_SYSCLK_NODIV);    /* Set. 72MHz Max. 72MHz */
	hw_rcc_set_adcpre(RCC_CFGR_ADCPRE_PCLK2_DIV8);  /* Set.  9MHz Max. 14MHz */
	hw_rcc_set_ppre1(RCC_CFGR_PPRE1_HCLK_DIV2);     /* Set. 36MHz Max. 36MHz */
	hw_rcc_set_ppre2(RCC_CFGR_PPRE2_HCLK_NODIV);    /* Set. 72MHz Max. 72MHz */
	 ...
	 */
	hw_rcc_set_pll_multiplication_factor(RCC_CFGR_PLLMUL_PLL_CLK_MUL9);

	/* Select HSE as PLL source. */
	hw_rcc_set_pll_source(RCC_CFGR_PLLSRC_HSE_CLK);
